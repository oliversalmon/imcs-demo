...
public class TradeMapStore implements MapStore<String, Trade> {
    ...
    public Trade load(String s) {
        ...
        try {
            ...
            result.setSecondaryFirmTradeId(Bytes.toString(getResult.getValue(CF_TRADE_DETAILS,SECONDARY_FIRM_TRADE_ID_FK)));
            ...
            result.setOriginalTradeDate(new Date(Bytes.toLong(getResult.getValue(CF_TRADE_DETAILS,ORIGINAL_TRADE_DATE))));
